...
const { FormError, RegistrationInput, RegistrationTitles: Title, LinkText } = styles

const Register = ({setRegister, setLoggedIn, setUsername, setName, setUserStatus, setLogin}) => {
