...
const connectWebSocket = async (token, socket, connection) => {
...
const disconnectPeerConnection = (connection) => {
...
const Video = ({username}) => {
        ...
        (async () => {
            ...
            if (token) {
                ...
                if (isWebcam) {
                    ...
                    await connectWebSocket(token, socket, connection)
                }
            }
        })()
    }, [])
    ...
    return (
        <Background>
            ...
            <button id="hangUpButton" onClick={() => disconnectPeerConnection(connection)}>Hang Up</button>
            <br/><br/>
